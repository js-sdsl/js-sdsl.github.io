Js-sdsl uses [karma](https://karma-runner.github.io/) and [mocha](https://mochajs.org/) to do unit tests and synchronize to [coveralls](https://coveralls.io/github/js-sdsl/js-sdsl).
