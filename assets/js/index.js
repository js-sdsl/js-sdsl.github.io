(function () {
  function getDocsifyConfig() {
    const alias = {
      ...
      '.*?/zh-cn/.*/_sidebar.md': '/zh-cn/_sidebar.md',
      '.*?/zh-cn/README': 'https://js-sdsl.org/js-sdsl/README.zh-CN.md',
      '.*?/zh-cn/test/benchmark-analyze': 'https://js-sdsl.org/benchmark/resultAnalyze.zh-CN.md',
      '.*?/_navbar.md': '/_navbar.md',
      '.*?/_sidebar.md': '/_sidebar.md',
      '.*?/README': 'https://js-sdsl.org/js-sdsl/README.md',
      '.*?/changelog': 'https://cdn.jsdelivr.net/npm/js-sdsl/CHANGELOG.md',
      '.*?/test/benchmark-result': 'https://js-sdsl.org/benchmark/README.md',
      '.*?/test/performance-test': 'https://js-sdsl.org/js-sdsl/performance.md',
      '.*?/test/benchmark-analyze': 'https://js-sdsl.org/benchmark/resultAnalyze.md'
    }
